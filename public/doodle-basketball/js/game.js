...
;(function () {
          ...
          : window.oRequestAnimationFrame
            ...
            : window.mozRequestAnimationFrame
              ...
              : window.msRequestAnimationFrame
                ...
                : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(u))
    },
    qa = function (a) {
      ka = v
      la = a || null
      ...
      ;(!navigator.webkitGamepads && !navigator.webkitGetGamepads) || ma || ((ma = !0), u())
    }
  var ra = function (a, b) {
      google &&
        google.doodle &&
  ...
  var Fa = -1 != w.indexOf('Opera') || -1 != w.indexOf('OPR'),
    ...
    Ja = (function () {
      var a = '',
        b
      if (Fa && m.opera) return (a = m.opera.version), 'function' == aa(a) ? a() : a
      Ga
        ? (b = /rv\:([^\);]+)(\)|;)/)
        : x
          ? (b = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/)
    ...
    La = m.document,
    Ma = La && x ? Ia() || ('CSS1Compat' == La.compatMode ? parseInt(Ja, 10) : 5) : void 0
  var Pa = function (a) {
      var b = new Image(),
        c = Na,
        d = ''
  ...
  var Qa,
    ...
    Ua = function () {
      var a =
        (window.localStorage && window.localStorage.getItem('doodle-basketball-tooltip')) || null
    ...
    Xa = function (a) {
      if (window.google && window.google.log) {
        var b
        Qa || ((b = document.getElementById('gameved')) && (Qa = b.getAttribute('data-ved')))
        ;(b = Qa) && (a += '&ved=' + b)
  ...
  var wb = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    ...
    Fb = function (a, b, c, d, e) {
      if ('array' == aa(b)) for (var f = 0; f < b.length; f++) Fb(a, b[f], c, d, e)
      else
        (c = Ab(c)),
          a && a[nb]
            ? a.unlisten(b, c, d, e)
    ...
    Gb = function (a) {
      ...
      yb--
      ;(c = Bb(b)) ? (ub(c, a), 0 == c.k && ((c.src = null), (b[wb] = null))) : qb(a)
      return !0
    },
    Db = function (a) {
  ...
  var Lb = function (a, b) {
    ...
    var g = !0,
      h
    if (c)
      for (var k = c.length - 1; !e.o && 0 <= k; k--) (h = e.k = c[k]), (g = Kb(h, f, !0, e) && g)
    e.o || ((h = e.k = d), (g = Kb(h, f, !0, e) && g), e.o || (g = Kb(h, f, !1, e) && g))
    if (c) for (k = 0; !e.o && k < c.length; k++) (h = e.k = c[k]), (g = Kb(h, f, !1, e) && g)
    return g
  }
  ...
  F.prototype.unlisten = function (a, b, c, d) {
    ...
    if (a in e.i) {
      ...
      b = sb(f, b, c, d)
      ;-1 < b
        ? (qb(f[b]), za.splice.call(f, b, 1), 0 == f.length && (delete e.i[a], e.k--), (e = !0))
        : (e = !1)
    } else e = !1
    return e
  }
  ...
  I.prototype.unlisten = function (a, b, c, d, e) {
    if ('array' == aa(b)) for (var f = 0; f < b.length; f++) this.unlisten(a, b[f], c, d, e)
    else
  ...
  Sb.prototype.H = function () {
    Tb() && -1 == w.indexOf('Trident') && -1 == w.indexOf('MSIE') && window.gapi && window.gapi.load
      ? (window.gapi.load('share', n(this.w, this)), Xa('gplus,li'))
      : (window.open('https://plus.google.com/share?url=' + this.D), Xa('gplus,lo'))
  }
  var Tb = function () {
  ...
  var Ub,
    ...
    tc = function (a) {
      ...
      Vb.appendChild(Ub)
      for (var e = 0; 3 > e; e++) (lc[e] = z('div', 'game_sm')), Vb.appendChild(lc[e])
      P.appendChild(Vb)
      e = function (a) {
        a = z('div', a)
        P.appendChild(a)
  ...
  Kc.prototype.C = function () {
    if (this.i.length) {
      for (var a = Za(this.s, 11), b = null, c = this.i.length - 1, d; (d = this.i[c]); c--)
        if (d.x + d.r < this.o || d.x - d.r > this.o + a.width || d.y - d.r > this.k + a.height)
          this.i.splice(c, 1)
      ...
      b &&
        ((a =
          b.y + b.r < this.k
            ? 0
            : Math.min(
                Math.floor(((b.y + b.r - this.k) / (a.height + b.r)) * this.p.length),
                this.p.length - 1
              )),
  ...
  var Zc = function (a) {
    ...
    Yc = function (a) {
      null !== a.w && (0 == a.k ? A(a.F, a.w, V, a.s, a.v) : A(a.I, a.w, V, a.s, a.v))
    },
    Xc = function (a, b) {
      var c = Vc(a, b)
    ...
    Uc = function (a, b) {
      ...
      a.M = b[2]
      a.H = b.U
      a.i && b[3] && b[4] && ((a.i.x = a.s + b[3] + a.A), (a.i.y = a.v + b[4] + a.B))
    },
    $c = function (a, b) {
      b ? (a.i = Jc(a.J)) : X(a, 1)
    },
    Wc = function (a, b) {
      a.o || (3 != a.k && (a.i || $c(a, !0), X(a, 2)), (a.o = W() - (b ? 200 : 0)))
    }
  var ad = [27, 28, 26, 24],
    bd = function (a, b, c) {
      this.i = a
  ...
  bd.prototype.C = function () {
    ...
    if (this.w && !this.p) b = 25
      ...
      var c = p() - this.p,
        d = 200 / ad.length
      200 <= c ? (b = 24) : (b = ad[Math.min(Math.floor(c / d), ad.length - 1)])
    } else b = 28
    ...
    24 == b &&
      ...
      a.rotate(this.s),
      A(this.i, 22, V, -b.width / 2 - (this.A - 36), -b.height / 2 - (this.B - 36)),
      a.restore())
    a.globalAlpha = 1
  }
  ...
  cd.prototype.C = function () {
    ...
    c && 1 == this.o && ((a.globalAlpha = Math.min(b / 1e3, 1)), A(this.s, 9, a, this.k, this.p))
    a.restore()
  }
  var ed = {
      ...
      fr: ['R\u00e9sultat', 'Basketball', "J'ai jou\u00e9 au basketball #GoogleDoodle"],
          ...
          if (1 <= this.G.o && !this.s) this.D = !1
            ...
            if (Z(this)) {
              ...
              if (
                ...
                (c = Math.min(this.A, 200 * b)), (this.v.k = this.v.k + c), (this.A -= c)
            }
            c = this.G
            c.o = Math.min(c.o + 2 * b, 1)
            !c.p ||
              200 > p() - c.p ||
              ((c.k += 150 * b), (c.s += ((150 * b) / (c.i.i[23][2] * Math.PI)) * 2 * Math.PI))
            c = this.k
            if (c.o != c.i) {
              var d = c.i - c.o
              c.o = Math.min(
                1,
                Math.max(0, c.o + (d / Math.abs(d)) * (1e3 / (c.o < c.i ? 200 : 100)) * b)
              )
            }
            c = this.i
            if (c.o && 2 == c.k) {
            ...
            c = this.v
            e = c.i.i
            c.i.x - c.i.r <= c.k && ((c.i.x = c.k + c.i.r), (e.x = 0.25 * -e.x))
            d = c.i
  ...
  var Z = function (a) {
    ...
    md = function (a, b, c) {
      ...
      return c.o(new U(a.M.start.x, a.M.start.y - b.P, a.M.end.x, a.M.end.y - b.P))
    }
  id.prototype.Ca = function () {
    ...
    setTimeout(
      n(function () {
        ...
        Xb.F = ic + b
        e || (e = Wb)
        Xb.B = 'https://www.google.com/logos/2012/' + e + '12-hp-share' + d + '.png'
        Ub.textContent = b
        for (b = 0; 3 > b; b++) lc[b].className = b < d ? 'game_smg' : 'game_smh'
        P.style.display = ''
        fb(Q)
        this.D = !1
      }, this),
  ...
  var pd = function (a) {
    ...
    Ua() ||
      (window.localStorage && window.localStorage.setItem('doodle-basketball-tooltip', '1'),
      (a.k.i = 1))
    ld(a)
    Wa()
    a.S ||
  ...
  l.za = function (a) {
    if (this.s && Y) {
        ...
        ? (b = a.targetTouches && a.targetTouches[0]) && void 0 !== b.pageX
          ...
          : void 0 !== a.clientX
            ? [
                ...
                a.clientY + (document.body.scrollTop || document.documentElement.scrollTop || 0),
              ]
            : void 0 !== a.pageX
              ? [a.pageX, a.pageY]
              : [0, 0]
      ...
      if ((c = 1 == this.k.i))
        (c = this.k),
          (d = Za(c.s, 8)),
          (c = a >= c.k && b >= c.p && a <= c.k + d.width && b <= c.p + d.height)
      c || qd(this)
    }
  }
  l.Aa = function () {
    ...
    nd = function (a, b) {
      if (b || (a.s && !(0 >= Z(a)))) {
        ...
        if (c.o && 2 != c.k) c.o = 0
          ...
          !c.o ||
            (200 > f && 2 > c.G) ||
            ((c.G = 0), (c.S = Math.min(f / 1e3, 1)), (c.o = 0), X(c, 3), (c.O = d), (c.T = e))
        }
      }
    }
  ...
  ;(function (a, b, c) {
    ...
    function () {
      !rd &&
        ...
        ((rd = !0),
        (v = sd),
        google.doodle && google.doodle.alt && sd.setAttribute('aria-label', google.doodle.alt),
        $a(td, function () {
          vd = new id(td, ud)
          ld(vd)
          $a(ud, function () {})

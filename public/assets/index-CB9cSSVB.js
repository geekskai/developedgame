function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = [
      "assets/IndexPage-DuV-R1Ea.js",
      "assets/utils-DMILY4l8.js",
      "assets/IndexPage-D9E146JY.css",
      "assets/PrivacyPage-DvoeqIe4.js",
    ];
  }
...
class Qr {
  ...
  run() {
    ...
    let t = ct,
      n = yt;
    try {
      return (ct = !0), (yt = this), this._runnings++, ws(this), this.fn();
    } finally {
      xs(this), this._runnings--, (yt = n), (ct = t);
    }
  }
  stop() {
    var t;
...
function xs(e) {
  if (e.deps.length > e._depsLength) {
    for (let t = e._depsLength; t < e.deps.length; t++) Do(e.deps[t], e);
...
function Yr() {
  for (Cr--; !Cr && Sr.length; ) Sr.shift()();
}
function Vo(e, t, n) {
  if (t.get(e) !== e._trackId) {
    t.set(e, e._trackId);
    const r = e.deps[e._depsLength];
    r !== t ? (r && Do(r, e), (e.deps[e._depsLength++] = t)) : e._depsLength++;
  }
}
const Sr = [];
function Uo(e, t, n) {
    ...
    r._dirtyLevel < t &&
      ...
      r._shouldSchedule &&
        ...
        (!r._runnings || r.allowRecurse) &&
          r._dirtyLevel !== 2 &&
          ((r._shouldSchedule = !1), r.scheduler && Sr.push(r.scheduler)));
  }
  Yr();
}
const Ko = (e, t) => {
...
function Ce(e, t, n) {
  if (ct && yt) {
    ...
    let s = r.get(n);
    s || r.set(n, (s = Ko(() => r.delete(n)))), Vo(yt, s);
  }
}
function Qe(e, t, n, r, s, o) {
  ...
  if (t === "clear") a = [...i.values()];
    ...
    switch ((n !== void 0 && a.push(i.get(n)), t)) {
      case "add":
        K(e)
          ? Kr(n) && a.push(i.get("length"))
          : (a.push(i.get(bt)), Jt(e) && a.push(i.get(Pr)));
        break;
      case "delete":
        K(e) || (a.push(i.get(bt)), Jt(e) && a.push(i.get(Pr)));
        break;
      case "set":
...
class Go {
  ...
  get(t, n, r) {
    ...
    if (n === "__v_raw")
      return r === (s ? (o ? Jl : Xo) : o ? Yo : Jo).get(t) ||
        Object.getPrototypeOf(t) === Object.getPrototypeOf(r)
        ? t
        : void 0;
    const i = K(t);
    if (!s) {
      if (i && X(Es, n)) return Reflect.get(Es, n, r);
      if (n === "hasOwnProperty") return Bl;
    }
    const a = Reflect.get(t, n, r);
    return (Un(n) ? Wo.has(n) : Il(n)) || (s || Ce(t, "get", n), o)
      ? a
      : Se(a)
      ? i && Kr(n)
        ? a
...
class Qo extends Go {
  ...
  set(t, n, r, s) {
    ...
    if (!this._isShallow) {
      const l = Bt(o);
      if (
        (!Nn(r) && !Bt(r) && ((o = Z(o)), (r = Z(r))), !K(t) && Se(o) && !Se(r))
      )
    ...
    return (
      t === Z(s) && (i ? ft(r, o) && Qe(t, "set", n, r) : Qe(t, "add", n, r)), a
    );
  }
  deleteProperty(t, n) {
    const r = X(t, n);
  ...
  has(t, n) {
    ...
    return (!Un(n) || !Wo.has(n)) && Ce(t, "has", n), r;
  }
  ownKeys(t) {
    return Ce(t, "iterate", K(t) ? "length" : bt), Reflect.ownKeys(t);
  }
}
class Fl extends Go {
  constructor(t = !1) {
...
function bn(e, t, n = !1, r = !1) {
  ...
  const s = Z(e),
    o = Z(t);
  n || (ft(t, o) && Ce(s, "get", t), Ce(s, "get", o));
  const { has: i } = Qn(s),
    a = r ? Xr : n ? ts : rn;
...
function wn(e, t = !1) {
  const n = this.__v_raw,
    ...
    s = Z(e);
  return (
    t || (ft(e, s) && Ce(r, "has", e), Ce(r, "has", s)),
    e === s ? n.has(e) : n.has(e) || n.has(s)
  );
}
function xn(e, t = !1) {
  return (
    (e = e.__v_raw), !t && Ce(Z(e), "iterate", bt), Reflect.get(e, "size", e)
  );
}
function Cs(e) {
  e = Z(e);
  const t = Z(this);
  return Qn(t).has.call(t, e) || (t.add(e), Qe(t, "add", e, e)), this;
}
function Ss(e, t) {
  t = Z(t);
  const n = Z(this),
  ...
  const i = s.call(n, e);
  return (
    n.set(e, t), o ? ft(t, i) && Qe(n, "set", e, t) : Qe(n, "add", e, t), this
  );
}
function Rs(e) {
  const t = Z(this),
...
function En(e, t) {
  return function (r, s) {
    const o = this,
      ...
      l = t ? Xr : e ? ts : rn;
    return (
      !e && Ce(a, "iterate", bt), i.forEach((f, c) => r.call(s, l(f), l(c), o))
    );
  };
}
function Cn(e, t, n) {
...
function zt(e) {
  return Object.isExtensible(e) && In(e, "__v_skip", !0), e;
}
  ...
  get value() {
    ...
    return (
      (!t._cacheable || t.effect.dirty) &&
        ft(t._value, (t._value = t.effect.run())) &&
        Pn(t, 4),
      ri(t),
...
function ri(e) {
  ...
  ct &&
    ...
    Vo(
      ...
      (t = e.dep) != null
        ? t
        : (e.dep = Ko(() => (e.dep = void 0), e instanceof ni ? e : void 0))
    ));
}
function Pn(e, t = 4, n) {
  e = Z(e);
...
class ta {
  ...
  set value(t) {
    ...
    (t = n ? t : Z(t)),
      ft(t, this._rawValue) &&
        ((this._rawValue = t), (this._value = n ? t : rn(t)), Pn(this, 4));
  }
}
function wt(e) {
...
function Jn(e, t, n, r = !0) {
  ...
  if (t) {
    ...
    for (; o; ) {
      const f = o.ec;
      if (f) {
        for (let c = 0; c < f.length; c++) if (f[c](e, i, a) === !1) return;
      }
      o = o.parent;
    }
...
function rs(e) {
  (!ye.length || !ye.includes(e, on && e.allowRecurse ? ze + 1 : ze)) &&
    (e.id == null ? ye.push(e) : ye.splice(sa(e.id), 0, e), ai());
}
function ai() {
  !on && !kr && ((kr = !0), (ns = ii.then(ui)));
}
function oa(e) {
...
function ia(e) {
  K(e)
    ? Nt.push(...e)
    : (!st || !st.includes(e, e.allowRecurse ? mt + 1 : mt)) && Nt.push(e),
    ai();
}
...
function ci(e) {
  if (Nt.length) {
    ...
    for (st = t, mt = 0; mt < st.length; mt++) st[mt]();
    (st = null), (mt = 0);
  }
}
...
function aa(e, t, ...n) {
  ...
  if (i && i in r) {
    ...
    d && (s = n.map((m) => (ge(m) ? m.trim() : m))), p && (s = n.map(El));
  }
  let a,
    l = r[(a = lr(t))] || r[(a = lr(Ue(t)))];
  !l && o && (l = r[(a = lr(Ht(t)))]), l && Le(l, e, 6, s);
  const f = r[a + "Once"];
  if (f) {
    if (!e.emitted) e.emitted = {};
    else if (e.emitted[a]) return;
    (e.emitted[a] = !0), Le(f, e, 6, s);
  }
}
function fi(e, t, n = !1) {
  ...
  return !o && !a
    ...
    : (K(o) ? o.forEach((l) => (i[l] = null)) : he(i, o),
      de(e) && r.set(e, i),
      i);
}
function Yn(e, t) {
...
function Bn(e) {
  const t = we;
  return (we = e), (Xn = (e && e.type.__scopeId) || null), t;
}
function Sd(e) {
  Xn = e;
}
...
function cr(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      const D = s || r,
        q = D;
      (C = De(c.call(q, D, p, o, m, d, b))), (R = l);
    } else {
      const D = t;
      (C = De(
        D.length > 1 ? D(o, { attrs: l, slots: a, emit: f }) : D(o, null)
      )),
        (R = t.props ? l : ua(l));
    }
  } catch (D) {
    (en.length = 0), Jn(D, e, 1), (C = Pe(Ye));
  }
  let B = C;
  if (R && T !== !1) {
    const D = Object.keys(R),
      { shapeFlag: q } = B;
    D.length && q & 7 && (i && D.some(Vr) && (R = fa(R, i)), (B = dt(B, R)));
  }
  return (
    n.dirs && ((B = dt(B)), (B.dirs = B.dirs ? B.dirs.concat(n.dirs) : n.dirs)),
...
function da(e, t, n) {
  ...
  if (n && l >= 0) {
    if (l & 1024) return !0;
    if (l & 16) return r ? Ts(r, i, f) : !!i;
    if (l & 8) {
      const c = t.dynamicProps;
      for (let p = 0; p < c.length; p++) {
        const d = c[p];
        if (i[d] !== r[d] && !Yn(f, d)) return !0;
      }
    }
  } else
...
function ma(e, t, n = !0, r = !1) {
  ...
  if (s) {
    ...
    if (e === di) {
      const a = dc(o, !1);
      if (a && (a === t || a === Ue(t) || a === Gn(Ue(t)))) return o;
    }
...
function hi(
  e,
  t,
  { immediate: n, deep: r, flush: s, once: o, onTrack: i, onTrigger: a } = ce
) {
  if (t && o) {
    const M = t;
    t = (...ee) => {
  ...
  const R = () => {
    if (!(!B.active || !B.dirty))
      if (t) {
        const M = B.run();
        (r || p || (d ? M.some((ee, j) => ft(ee, C[j])) : ft(M, C))) &&
          (m && m(),
  ...
  s === "sync"
    ...
    : s === "post"
    ? (N = () => Ee(R, l && l.suspense))
    : ((R.pre = !0), l && (R.id = l.uid), (N = () => rs(R)));
  const B = new Qr(c, Ae, N),
    D = $l(),
    q = () => {
      B.stop(), D && Ur(D.effects, B);
    };
  return (
    t
      ? n
...
function _t(e, t, n = 0, r) {
  ...
  if ((r.add(e), Se(e))) _t(e.value, t, n, r);
  else if (K(e)) for (let s = 0; s < e.length; s++) _t(e[s], t, n, r);
  else if (vl(e) || Jt(e))
    e.forEach((s) => {
      _t(s, t, n, r);
    });
  else if (bl(e)) for (const s in e) _t(e[s], t, n, r);
  return e;
}
function xa(e, t) {
  if (we === null) return e;
        ...
        if (p && p.type !== Ye && !vt(l, p)) {
          ...
          a === "in-out" &&
            ...
            (d.delayLeave = (m, b, T) => {
              ...
              (C[String(p.key)] = p),
                (m[ot] = () => {
                  b(), (m[ot] = void 0), delete f.delayedLeave;
                }),
                (f.delayedLeave = T);
            });
        }
  ...
  const {
    ...
    ee = {
      ...
      beforeEnter(j) {
        ...
        j[ot] && j[ot](!0);
        const Y = D[B];
        Y && vt(e, Y) && Y.el[ot] && Y.el[ot](), q(Q, [j]);
      },
      enter(j) {
        let Q = l,
          Y = f,
      ...
      leave(j, Q) {
        ...
        if ((j[Rn] && j[Rn](!0), n.isUnmounting)) return Q();
        q(p, [j]);
        let te = !1;
        const O = (j[ot] = (J) => {
          te ||
...
function ur(e) {
  if (Zn(e)) return (e = dt(e)), (e.children = null), e;
}
function Ls(e) {
...
function ss(e, t = !1, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    i.type === Ne
      ? (i.patchFlag & 128 && s++, (r = r.concat(ss(i.children, t, a))))
      : (t || i.type !== Ye) && r.push(a != null ? dt(i, { key: a }) : i);
  }
  if (s > 1) for (let o = 0; o < r.length; o++) r[o].patchFlag = -2;
  return r;
}
/*! #__NO_SIDE_EFFECTS__ */ function os(e, t) {
  return W(e) ? he({ name: e.name }, t, { setup: e }) : e;
}
...
function _i(e, t, n = me) {
  ...
  if ((er(t, r, n), n)) {
    let s = n.parent;
    for (; s && s.parent; )
      Zn(s.parent.vnode) && Pa(r, t, n, s), (s = s.parent);
  }
}
function Pa(e, t, n, r) {
  const s = er(t, e, r, !0);
    ...
    get({ _: e }, t) {
      ...
      if (t[0] !== "$") {
        ...
        if (m !== void 0)
          ...
          if (s !== ce && X(s, t)) return (i[t] = 2), s[t];
          if ((f = e.propsOptions[0]) && X(f, t)) return (i[t] = 3), o[t];
          if (n !== ce && X(n, t)) return (i[t] = 4), n[t];
          Ar && (i[t] = 0);
        }
      }
      const c = Xt[t];
      ...
      if (n !== ce && X(n, t)) return (i[t] = 4), n[t];
      if (((d = l.config.globalProperties), X(d, t))) return d[t];
    },
    set({ _: e }, t, n) {
...
function Ia(e) {
  ...
  if (a) for (const ie in a) xi(a[ie], r, n, ie);
  if (l) {
...
function xi(e, t, n, r) {
  ...
  if (ge(e)) {
    const o = t[e];
    W(o) && kn(s, o);
  } else if (W(e)) kn(s, e.bind(n));
  else if (de(e))
    if (K(e)) e.forEach((o) => xi(o, t, n, r));
    else {
...
function ls(e) {
  ...
  return (
    a
      ...
      : !s.length && !n && !r
      ? (l = t)
      : ((l = {}), s.length && s.forEach((f) => Fn(l, f, i, !0)), Fn(l, t, i)),
    de(t) && o.set(t, l),
    l
  );
}
...
function Is(e, t) {
  return e
    ? K(e) && K(t)
      ? [...new Set([...e, ...t])]
      : he(Object.create(null), Os(e), Os(t ?? {}))
    : t;
}
function qa(e, t) {
  if (!e) return t;
...
function Ha(e, t) {
  return function (r, s = null) {
    ...
    const l = (o.app = {
      ...
      component(f, c) {
        return c ? ((o.components[f] = c), l) : o.components[f];
      },
      directive(f, c) {
        return c ? ((o.directives[f] = c), l) : o.directives[f];
      },
      mount(f, c, p) {
        if (!a) {
          const d = Pe(r, s);
...
function Da(e, t, n, r = !1) {
  const s = {},
    o = {};
  In(o, nr, 1), (e.propsDefaults = Object.create(null)), Ci(e, t, s, o);
...
function za(e, t, n, r) {
  ...
  if ((r || i > 0) && !(i & 16)) {
    if (i & 8) {
      ...
      for (let p = 0; p < c.length; p++) {
        let d = c[p];
        if (Yn(e.emitsOptions, d)) continue;
        const m = t[d];
        if (l)
          if (X(o, d)) m !== o[d] && ((o[d] = m), (f = !0));
          else {
            const b = Ue(d);
            s[b] = Or(l, a, b, m, e, !1);
          }
        else m !== o[d] && ((o[d] = m), (f = !0));
      }
    }
  } else {
    Ci(e, t, s, o) && (f = !0);
    let c;
    for (const p in a)
      (!t || (!X(t, p) && ((c = Ht(p)) === p || !X(t, c)))) &&
        (l
          ? n &&
            (n[p] !== void 0 || n[c] !== void 0) &&
            (s[p] = Or(l, a, p, void 0, e, !0))
          : delete s[p]);
    if (o !== a) for (const p in o) (!t || !X(t, p)) && (delete o[p], (f = !0));
  }
  f && Qe(e, "set", "$attrs");
}
function Ci(e, t, n, r) {
...
function Si(e, t, n = !1) {
  ...
  if (!o && !l) return de(e) && r.set(e, Mt), Mt;
  if (K(o))
    for (let c = 0; c < o.length; c++) {
      const p = Ue(o[c]);
      Ns(p) && (i[p] = ce);
...
const Ri = (e) => e[0] === "_" || e === "$stable",
  ...
  Ua = (e, t) => {
    if (e.vnode.shapeFlag & 32) {
      const n = t._;
      n ? ((e.slots = Z(t)), In(t, "_", n)) : Pi(t, (e.slots = {}));
...
function Ga(e, t) {
  ...
  const {
    ...
    T = (
      ...
      if (u === h) return;
      u && !vt(u, h) && ((y = _(u)), xe(u, v, E, !0), (u = null)),
      ...
      switch (w) {
        ...
        default:
          H & 1
            ...
            : H & 6
            ? J(u, h, g, y, v, E, k, x, S)
            : (H & 64 || H & 128) && w.process(u, h, g, y, v, E, k, x, S, I);
      }
      L != null && v && $r(L, u && u.ref, E, h || u, !h);
    },
    C = (u, h, g, y) => {
      if (u == null) r((h.el = a(h.children)), g, y);
      else {
        const v = (h.el = u.el);
    ...
    M = (u, h, g, y, v, E, k, x) => {
      ...
      if (
        ((S = u.el = i(u.type, E, L && L.is, L)),
        H & 8
          ? c(S, u.children)
          : H & 16 && j(u.children, S, null, y, v, dr(u, E), k, x),
        ...
        for (const le in L)
          le !== "value" &&
            !Yt(le) &&
            o(S, le, null, L[le], E, u.children, y, v, ve);
      ...
      G && F.beforeEnter(S),
        r(S, h, g),
        ((w = L && L.onVnodeMounted) || G || U) &&
          Ee(() => {
            w && He(w, y, u), G && F.enter(S), U && ht(u, null, y, "mounted");
          }, v);
    },
    ee = (u, h, g, y, v) => {
      if ((g && m(u, g), y)) for (let E = 0; E < y.length; E++) m(u, y[E]);
      if (v) {
        let E = v.subTree;
        if (h === E) {
          const k = v.vnode;
    ...
    Q = (u, h, g, y, v, E, k) => {
      ...
      if (
        ...
        g && pt(g, !0),
        w
          ? Y(u.dynamicChildren, w, x, g, y, dr(h, v), E)
          : k || re(u, h, x, null, g, y, dr(h, v), E, !1),
        S > 0)
      ) {
        if (S & 16) te(x, h, H, F, g, y, v);
        else if (
          (S & 2 && H.class !== F.class && o(x, "class", null, F.class, v),
          ...
          for (let le = 0; le < G.length; le++) {
            const fe = G[le],
              ...
              Oe = F[fe];
            (Oe !== pe || fe === "value") &&
              o(x, fe, pe, Oe, v, u.children, g, y, ve);
          }
        }
        S & 1 && u.children !== h.children && c(x, h.children);
      } else !k && w == null && te(x, h, H, F, g, y, v);
      ((U = F.onVnodeUpdated) || L) &&
        Ee(() => {
          U && He(U, g, h, u), L && ht(h, u, g, "updated");
        }, y);
    },
    Y = (u, h, g, y, v, E, k) => {
      for (let x = 0; x < h.length; x++) {
        const S = u[x],
          w = h[x],
          L =
            S.el && (S.type === Ne || !vt(S, w) || S.shapeFlag & 70)
              ? p(S.el)
              : g;
    ...
    O = (u, h, g, y, v, E, k, x, S) => {
      ...
      U && (x = x ? x.concat(U) : U),
        u == null
          ? (r(w, g, y), r(L, g, y), j(h.children || [], g, L, v, E, k, x, S))
          : H > 0 && H & 64 && F && u.dynamicChildren
          ? (Y(u.dynamicChildren, F, g, v, E, k, x),
            (h.key != null || (v && h === v.subTree)) && Ti(u, h, !0))
          : re(u, h, g, L, v, E, k, x, S);
    },
    J = (u, h, g, y, v, E, k, x, S) => {
      (h.slotScopeIds = x),
        u == null
          ? h.shapeFlag & 512
            ? v.ctx.activate(h, g, y, k, S)
            : $(h, g, y, v, E, k, S)
          : ne(u, h, S);
    },
    $ = (u, h, g, y, v, E, k) => {
      const x = (u.component = lc(u, y, v));
      if ((Zn(u) && (x.ctx.renderer = I), ac(x), x.asyncDep)) {
        if ((v && v.registerDep(x, ae), !u.el)) {
          const S = (x.subTree = Pe(Ye));
          R(null, S, h, g);
        }
      } else ae(x, u, h, g, v, E, k);
    },
    ne = (u, h, g) => {
      ...
      if (da(u, h, g))
        if (y.asyncDep && !y.asyncResolved) {
          ie(y, h, g);
          return;
        } else (y.next = h), oa(y.update), (y.effect.dirty = !0), y.update();
      ...
      const x = () => {
          if (u.isMounted) {
            ...
            if (
              ...
              const pe = () => {
                (u.subTree = cr(u)), ue(H, u.subTree, u, v, null);
              };
              fe
                ? h.type.__asyncLoader().then(() => !u.isUnmounted && pe())
                : pe();
            } else {
              const pe = (u.subTree = cr(u));
              T(null, pe, g, y, u, v, E), (h.el = pe.el);
            }
            if ((G && Ee(G, v), !fe && (L = F && F.onVnodeMounted))) {
              const pe = h;
              Ee(() => He(L, le, pe), v);
            }
            (h.shapeFlag & 256 ||
              (le && Tn(le.vnode) && le.vnode.shapeFlag & 256)) &&
              u.a &&
              Ee(u.a, v),
              (u.isMounted = !0),
              (h = g = y = null);
    ...
    re = (u, h, g, y, v, E, k, x, S = !1) => {
      ...
      U & 8
        ? (L & 16 && ve(w, v, E), H !== w && c(g, H))
        : L & 16
        ? U & 16
          ? Ze(w, H, g, y, v, E, k, x, S)
          : ve(w, v, E, !0)
        : (L & 8 && c(g, ""), U & 16 && j(H, g, y, v, E, k, x, S));
    },
    ...
    Ze = (u, h, g, y, v, E, k, x, S) => {
      ...
      for (; w <= H && w <= F; ) {
        ...
        if (vt(U, G)) T(U, G, g, null, v, E, k, x, S);
        else break;
        w++;
      }
      for (; w <= H && w <= F; ) {
      ...
      if (w > H) {
        if (w <= F) {
          const U = F + 1,
            G = U < L ? h[U].el : y;
          for (; w <= F; )
            T(null, (h[w] = S ? it(h[w]) : De(h[w])), g, G, v, E, k, x, S), w++;
        }
      } else if (w > F) for (; w <= H; ) xe(u[w], v, E, !0), w++;
      else {
        const U = w,
          G = w,
          le = new Map();
        ...
        for (w = U; w <= H; w++) {
          ...
          let je;
          if (Re.key != null) je = le.get(Re.key);
          else
            for (fe = G; fe <= F; fe++)
        ...
        for (fe = _s.length - 1, w = Oe - 1; w >= 0; w--) {
          const Re = G + w,
            je = h[Re],
            ys = Re + 1 < L ? h[Re + 1].el : y;
          Vt[w] === 0
            ? T(null, je, g, ys, v, E, k, x, S)
            : Pt && (fe < 0 || w !== _s[fe] ? qe(je, g, ys, 2) : fe--);
        }
      }
    },
    qe = (u, h, g, y, v = null) => {
      ...
      if (k === Ne) {
        r(E, h, g);
        for (let H = 0; H < S.length; H++) qe(S[H], h, g, y);
        r(u.anchor, h, g);
        return;
      }
      if (k === hr) {
      ...
      if (y !== 2 && w & 1 && x)
        if (y === 0) x.beforeEnter(E), r(E, h, g), Ee(() => x.enter(E), v);
        else {
    ...
    xe = (u, h, g, y = !1, v = !1) => {
      ...
      if ((x != null && $r(x, null, g, u, !0), L & 256)) {
        h.ctx.deactivate(u);
        return;
      }
      const U = L & 1 && F,
        G = !Tn(u);
      let le;
      if ((G && (le = k && k.onVnodeBeforeUnmount) && He(le, h, u), L & 6))
        yn(u.component, g, y);
      else {
        if (L & 128) {
        ...
        U && ht(u, null, h, "beforeUnmount"),
          L & 64
            ? u.type.remove(u, h, g, v, I, y)
            : w && (E !== Ne || (H > 0 && H & 64))
            ? ve(w, h, g, !1, !0)
            : ((E === Ne && H & 384) || (!v && L & 16)) && ve(S, h, g),
          y && St(u);
      }
      ((G && (le = k && k.onVnodeUnmounted)) || U) &&
        Ee(() => {
          le && He(le, h, u), U && ht(u, null, h, "unmounted");
        }, g);
    },
    St = (u) => {
    ...
    ve = (u, h, g, y = !1, v = !1, E = 0) => {
      for (let k = E; k < u.length; k++) xe(u[k], h, g, y, v);
    },
    _ = (u) =>
      u.shapeFlag & 6
  ...
  const P = (u, h, g) => {
      u == null
        ...
        : T(h._vnode || null, u, h, null, null, null, g),
        A || ((A = !0), ks(), ci(), (A = !1)),
        (h._vnode = u);
    },
    I = {
  ...
  let se, ue;
  return (
    t && ([se, ue] = t(I)), { render: P, hydrate: se, createApp: Ha(P, se) }
  );
}
...
function Li(e) {
  return (
    (e.dynamicChildren = un > 0 ? Be || Mt : null),
    Za(),
    un > 0 && Be && Be.push(e),
    e
  );
...
function tc(e, t = null, n = null, r = 0, s = null, o = !1) {
  ...
  if ((hc(e) && (e = e.__vccOpts), t)) {
    ...
    a && !ge(a) && (t.class = Gr(a)),
      de(l) && (ti(l) && !K(l) && (l = he({}, l)), (t.style = Wr(l)));
  }
...
function dt(e, t, n = !1) {
  ...
  return {
    ...
    key: a && Oi(a),
    ref:
      t && t.ref ? (n && s ? (K(s) ? s.concat(Ln(t)) : [s, Ln(t)]) : Ln(t)) : s,
    scopeId: e.scopeId,
...
function cc(e, t) {
  const n = e.type;
  (e.accessCache = Object.create(null)), (e.proxy = zt(new Proxy(e.ctx, Ma)));
  const { setup: r } = n;
  if (r) {
    ...
    if (!t && zs && !r.render) {
      ...
      if (s) {
        const { isCustomElement: o, compilerOptions: i } = e.appContext.config,
          ...
          f = he(he({ isCustomElement: o, delimiters: a }, i), l);
        r.render = zs(s, f);
      }
    }
...
function sr(e) {
  if (e.exposed)
    return (
      e.exposeProxy ||
      (e.exposeProxy = new Proxy(oi(zt(e.exposed)), {
        get(t, n) {
 ...
 **/ const gc = "http://www.w3.org/2000/svg",
  ...
  vc = {
    ...
    createElement: (e, t, n, r) => {
      const s =
        t === "svg"
          ? lt.createElementNS(gc, e)
          : t === "mathml"
          ? lt.createElementNS(mc, e)
...
function Bi(e) {
  const t = {};
  for (const O in e) O in Ni || (t[O] = e[O]);
  if (e.css === !1) return t;
  const {
      name: n = "v",
      type: r,
    ...
    Q = (O, J, $) => {
      rt(O, J ? c : a), rt(O, J ? f : i), $ && $();
    },
    Y = (O, J) => {
      (O._isLeaving = !1), rt(O, p), rt(O, m), rt(O, d), J && J();
    },
    te = (O) => (J, $) => {
      const ne = O ? ee : N,
        ae = () => Q(J, O, $);
      gt(ne, [J, ae]),
        Ks(() => {
          rt(J, O ? l : o), Ge(J, O ? c : a), Us(ne) || Ws(J, r, T, ae);
        });
    };
  return he(t, {
    onBeforeEnter(O) {
      gt(R, [O]), Ge(O, o), Ge(O, i);
    },
    onBeforeAppear(O) {
      gt(M, [O]), Ge(O, l), Ge(O, f);
    },
    onEnter: te(!1),
    onAppear: te(!0),
    onLeave(O, J) {
      ...
      Ge(O, p),
        ...
        Ge(O, d),
        Ks(() => {
          O._isLeaving && (rt(O, p), Ge(O, m), Us(D) || Ws(O, r, C, $));
        }),
        gt(D, [O, $]);
    },
    onEnterCancelled(O) {
...
function Fi(e, t) {
  ...
  let c = null,
    ...
    d = 0;
  t === tt
    ? i > 0 && ((c = tt), (p = i), (d = o.length))
    : t === Ut
    ? f > 0 && ((c = Ut), (p = f), (d = l.length))
    : ((p = Math.max(i, f)),
      (c = p > 0 ? (i > f ? tt : Ut) : null),
      (d = c ? (c === tt ? o.length : l.length) : 0));
  const m =
    c === tt && /\b(transform|all)(,|$)/.test(r(`${tt}Property`).toString());
...
function Sc(e, t, n) {
  ...
  if (n && !s) {
    ...
    if (t !== n) {
      const i = r[Ec];
      i && (n += ";" + i), (r.cssText = n), (o = Cc.test(n));
    }
  } else t && e.removeAttribute("style");
  Js in e && ((e[Js] = o ? r.display : ""), e[xc] && (r.display = "none"));
}
const Ys = /\s*!important$/;
function On(e, t, n) {
  if (K(n)) n.forEach((r) => On(e, t, r));
  else if ((n == null && (n = ""), t.startsWith("--"))) e.setProperty(t, n);
  else {
    const r = Rc(e, t);
    Ys.test(n)
      ? e.setProperty(Ht(r), n.replace(Ys, ""), "important")
      : (e[r] = n);
  }
}
...
const ji = new WeakMap(),
  ...
  Di = {
    ...
    props: he({}, _c, { tag: String, moveClass: String }),
    setup(e, { slots: t }) {
      const n = gn(),
        r = gi();
      let s, o;
      return (
        bi(() => {
          ...
          if (!Vc(s[0].el, n.vnode.el, i)) return;
          s.forEach(Hc), s.forEach(Dc);
          const a = s.filter(zc);
          qi(),
            a.forEach((l) => {
              const f = l.el,
              ...
              const p = (f[jn] = (d) => {
                (d && d.target !== f) ||
                  ((!d || /transform$/.test(d.propertyName)) &&
                    (f.removeEventListener("transitionend", p),
                    (f[jn] = null),
                    rt(f, i)));
              });
        ...
        () => {
          ...
          if (s)
            for (let f = 0; f < s.length; f++) {
              const c = s[f];
              cn(c, an(c, a, r, n)), ji.set(c, c.el.getBoundingClientRect());
            }
          return Pe(l, null, o);
        }
      );
...
const oo = navigator.userAgent || navigator.vendor || window.opera,
  Xc = { has: { touch: !1, webStorage: !1 }, within: { iframe: !1 } },
  Ve = {
    userAgent: oo,
    is: Yc(oo),
    has: { touch: Vi },
    ...
    install(e) {
      ...
      xt.value === !0
        ? (e.onSSRHydrated.push(() => {
            Object.assign(t.platform, Ve), (xt.value = !1);
          }),
          (t.platform = Dt(this)))
        : (t.platform = this);
    },
  };
{
  ...
  fs(Ve.has, "webStorage", () => {
    ...
    Object.assign(Br, Ve),
    xt.value === !0 && (Object.assign(Br, Nr, Xc), (Nr = null));
}
const or = (e, t) => {
    const n = Dt(e);
    for (const r in e)
  ...
  vn = { hasPassive: !1, passiveCapture: !0, notPassiveCapture: !0 };
try {
...
function lu(e) {
  ...
  if (e.backButtonExit === "*") return Ki;
  const t = ["#/"];
  return (
    Array.isArray(e.backButtonExit) === !0 &&
      t.push(...e.backButtonExit.filter(ou).map(iu)),
...
const au = {
    ...
    install({ $q: e }) {
      ...
      if (
        ...
        return;
      (this.add = (i) => {
        i.condition === void 0 && (i.condition = Ki), this.__history.push(i);
      }),
        (this.remove = (i) => {
          const a = this.__history.indexOf(i);
          a >= 0 && this.__history.splice(a, 1);
        });
      const s = lu(Object.assign({ backButtonExit: !0 }, r)),
        o = () => {
...
function fu(e) {
  return (
    Wi === !0 || e !== Object(e) || e.isComposing === !0 || e.qKeyEvent === !0
  );
}
function Fr(e, t) {
  ...
  Hn = or(
    { iconMapFn: null, __icons: {} },
    {
      set(e, t) {
        ...
        (n.set = Hn.set), Object.assign(Hn.__icons, n);
      },
    ...
    t.plugins !== void 0 &&
      uo(
        ...
        Object.values(t.plugins).filter(
          (r) => typeof r.install == "function" && co.includes(r) === !1
        )
      ),
    xt.value === !0 &&
      (n.$q.onSSRHydrated = () => {
...
const wu = function (e, t = {}) {
    ...
    Qi === !1
      ? (t.config !== void 0 && Object.assign(Dn, t.config),
        (n.config = { ...Dn }),
        _u())
      : (n.config = t.config || {}),
      bu(e, t, {
  ...
  xu = { version: "2.15.2", install: wu, lang: Me, iconSet: Hn },
  Eu = (e, t) => {
...
function yr(e, t, n = "/") {
  ...
  return (
    ...
    (r = Uu(r ?? t, n)),
    { fullPath: r + (o && "?") + o + i, path: r, query: s, hash: hn(i) }
  );
}
function Du(e, t) {
...
function ef(e, t, n, r) {
  ...
  function c() {
    ...
    d.state && d.replaceState(oe({}, d.state, { scroll: ir() }), "");
  }
  function p() {
    for (const d of o) d();
    (o = []),
...
function tf(e) {
  ...
  function a(l, f) {
    const c = oe({}, s.value, t.state, { forward: l, scroll: ir() });
    o(c.current, c, !0);
    const p = oe({}, go(r.value, l, null), { position: c.position + 1 }, f);
    o(l, p, !1), (r.value = l);
  }
...
function nf(e) {
  ...
  const s = oe(
    { location: "", base: e, go: r, createHref: Gu.bind(null, e) },
    t,
    n
  );
  return (
...
function jt(e, t) {
  return oe(new Error(), { type: e, [sl]: !0 }, t);
}
function We(e, t) {
...
function lf(e, t) {
  ...
  for (const f of e) {
    ...
    for (let p = 0; p < f.length; p++) {
      ...
      if (d.type === 0)
        p || (s += "/"), (s += d.value.replace(of, "\\$&")), (m += 40);
      else if (d.type === 1) {
        const { value: b, repeatable: T, optional: C, regexp: R } = d;
        o.push({ name: b, repeatable: T, optional: C });
        const N = R || vo;
        if (N !== vo) {
          m += 10;
          try {
            ...
            throw new Error(
              `Invalid custom RegExp for param "${b}" (${N}): ` + D.message
            );
          }
        }
        let B = T ? `((?:${N})(?:/(?:${N}))*)` : `(${N})`;
...
function pf(e, t) {
  ...
  function o(c, p, d) {
    ...
    for (const B of C) {
      ...
      if (
        ...
        const q = b.children;
        for (let M = 0; M < q.length; M++) o(q[M], R, d && d.children[M]);
      }
      (d = d || R),
  ...
  function l(c) {
    ...
    for (
      ...
      p < n.length &&
      cf(c, n[p]) >= 0 &&
      (c.record.path !== n[p].record.path || !ol(c, n[p]));

    )
      p++;
    n.splice(p, 0, c), c.record.name && !bo(c) && r.set(c.record.name, c);
  }
  function f(c, p) {
    let d,
      m = {},
      ...
      T;
    if ("name" in c && c.name) {
      if (((d = r.get(c.name)), !d)) throw jt(1, { location: c });
      (T = d.record.name),
        (m = oe(
          yo(
            p.params,
            d.keys
              .filter((N) => !N.optional)
              .concat(d.parent ? d.parent.keys.filter((N) => N.optional) : [])
              .map((N) => N.name)
          ),
          c.params &&
            yo(
      ...
      (b = c.path),
        ...
        d && ((m = d.parse(b)), (T = d.record.name));
    else {
      if (((d = p.name ? r.get(p.name) : n.find((N) => N.re.test(p.path))), !d))
        throw jt(1, { location: c, currentLocation: p });
      (T = d.record.name),
    ...
    return { name: T, path: b, params: m, matched: C, meta: vf(C) };
  }
  return (
    e.forEach((c) => o(c)),
    {
...
function at(e, t, n, r, s, o = (i) => i()) {
  ...
  return () =>
    new Promise((a, l) => {
      ...
      e.length < 3 && (p = p.then(f)), p.catch((d) => l(d));
    });
}
...
function Co(e) {
  const t = Je(hs),
    ...
    s = V(() => {
      ...
      if (d > -1) return d;
      const m = So(l[f - 2]);
      return f > 1 && So(c) === m && p[p.length - 1].path !== m
        ? p.findIndex(qt.bind(null, l[f - 2]))
        : d;
    }),
  ...
  function a(l = {}) {
    return Cf(l)
      ? t[wt(e.replace) ? "replace" : "push"](wt(e.to)).catch(tn)
      : Promise.resolve();
  }
  return {
    route: r,
          ...
          ([f, c, p], [d, m, b]) => {
            c &&
              ...
              f &&
                c &&
                (!m || !qt(c, m) || !d) &&
                (c.enterCallbacks[p] || []).forEach((T) => T(f));
          },
          { flush: "post" }
        ),
        () => {
          const f = s.value,
            ...
            p = a.value,
            d = p && p.components[c];
          if (!d) return Po(n.default, { Component: d, route: f });
          const m = p.props[c],
            b = m
              ? m === !0
                ? f.params
          ...
          return Po(n.default, { Component: C, route: f }) || C;
        }
      );
    },
  });
...
function kf(e) {
  ...
  function m(_, A) {
    let P, I;
    return (
      rl(_) ? ((P = t.getRecordMatcher(_)), (I = A)) : (I = _), t.addRoute(I, P)
    );
  }
  function b(_) {
  ...
  function R(_, A) {
    if (((A = oe({}, A || l.value)), typeof _ == "string")) {
      const h = yr(n, _, A.path),
        g = t.resolve({ path: h.path }, A),
    ...
    let P;
    if (_.path != null) P = oe({}, _, { path: yr(n, _.path, A.path).path });
    else {
      const h = oe({}, _.params);
      for (const g in h) h[g] == null && delete h[g];
      (P = oe({}, _, { params: p(h) })), (A.params = p(A.params));
    }
    const I = t.resolve(P, A),
      se = _.hash || "";
    I.params = c(d(I.params));
    const ue = Du(r, oe({}, _, { hash: Nu(se), path: I.path })),
      u = s.createHref(ue);
    return oe(
      { fullPath: ue, hash: se, query: r === xo ? yf(_.query) : _.query || {} },
      I,
  ...
  function B(_, A) {
    if (f !== _) return jt(8, { from: A, to: _ });
  }
  function D(_) {
    return ee(_);
  }
  function q(_) {
    return D(oe(N(_), { replace: !0 }));
  }
  function M(_) {
  ...
  function ee(_, A) {
    ...
    return (
      !ue &&
        zu(r, I, P) &&
        ((y = jt(16, { to: g, from: I })), qe(I, I, !0, !1)),
      (y ? Promise.resolve(y) : Y(g, I))
        .catch((v) => (We(v) ? (We(v, 2) ? v : Ze(v)) : re(v, g, I)))
        .then((v) => {
          if (v) {
            if (We(v, 2))
              return ee(
  ...
  function Y(_, A) {
    ...
    return (
      ...
      ve(P)
        .then(() => {
          P = [];
          for (const h of o.list()) P.push(at(h, _, A));
          return P.push(u), ve(P);
        })
        .then(() => {
        ...
        .then(() => {
          ...
          for (const h of ue)
            if (h.beforeEnter)
              if (Fe(h.beforeEnter))
                for (const g of h.beforeEnter) P.push(at(g, _, A));
              else P.push(at(h.beforeEnter, _, A));
          return P.push(u), ve(P);
        })
        .then(
          () => (
        ...
        .then(() => {
          P = [];
          for (const h of i.list()) P.push(at(h, _, A));
          return P.push(u), ve(P);
        })
  ...
  function O(_, A, P, I, se) {
    ...
    P &&
      (I || u
        ? s.replace(_.fullPath, oe({ scroll: u && h && h.scroll }, se))
        : s.push(_.fullPath, se)),
      (l.value = _),
      qe(_, A, P, u),
      Ze();
  }
            ...
            .catch((u) =>
              We(u, 12)
                ...
                ? (ee(u.to, I)
                    ...
                    .catch(tn),
                  Promise.reject())
                : (P.delta && s.go(-P.delta, !1), re(u, I, ue))
            )
            .then((u) => {
              (u = u || O(I, ue, !1)),
                u &&
                  (P.delta && !We(u, 8)
                    ? s.go(-P.delta, !1)
                    : P.type === pn.pop && We(u, 20) && s.go(-1, !1)),
                te(I, ue, u);
            })
            .catch(tn);
      }));
  ...
  function re(_, A, P) {
    ...
    const I = ae.list();
    return (
      I.length ? I.forEach((se) => se(_, A, P)) : console.error(_),
      Promise.reject(_)
    );
  }
  function Ke() {
  ...
  function qe(_, A, P, I) {
    ...
    if (!Ot || !se) return Promise.resolve();
    const ue =
      (!P && Xu(po(_.fullPath, 0))) ||
  ...
  const Rt = new Set(),
    yn = {
      ...
      install(_) {
        ...
        _.provide(hs, A), _.provide(il, Zo(P)), _.provide(Hr, l);
        const I = _.unmount;
        Rt.add(_),
          (_.unmount = function () {
            Rt.delete(_),
...
const Af = (function () {
    ...
    if (n && n.length > 0) {
      ...
      s = Promise.all(
        n.map((l) => {
          ...
          if (
            ((d.rel = f ? "stylesheet" : Af),
            f || ((d.as = "script"), (d.crossOrigin = "")),
            (d.href = l),
  ...
  Of = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            wr(
              () => import("./PrivacyPage-DvoeqIe4.js"),
              __vite__mapDeps([3, 1])
            ),
        },
      ],
  ...
  xr = function () {
    return kf({
      ...
      routes: Of,
      history: nf("/doodle-cricket-game"),
    });
  };
...
const Dr = { xs: 18, sm: 24, md: 32, lg: 38, xl: 46 },
  ps = { size: String };
function gs(e, t = Dr) {
  return V(() =>
    e.size !== void 0
...
const To = "0 0 24 24",
  ...
  al = { o_: "-outlined", r_: "-round", s_: "-sharp" },
  cl = { sym_o_: "-outlined", sym_r_: "-rounded", sym_s_: "-sharp" },
    ...
    setup(e, { slots: t }) {
      const {
        ...
        o = V(() => {
          ...
          if (n.iconMapFn !== null) {
            ...
            if (c !== void 0)
              if (c.icon !== void 0) {
                if (((a = c.icon), a === "none" || !a)) return { none: !0 };
              } else
                return {
                  cls: c.cls,
          ...
          if (qf.test(a) === !0) {
            ...
            return {
              ...
              nodes: c.split("&&").map((d) => {
                const [m, b, T] = d.split("@@");
                return z("path", { style: b, d: m, transform: T });
              }),
            };
          }
          if (jf.test(a) === !0) return { img: !0, src: a.substring(4) };
          if (Hf.test(a) === !0) {
            const [c, p = To] = a.split("|");
          ...
          let l = " ";
          const f = a.match(Bf);
          if (f !== null) i = ll[f[1]](a);
          else if (zf.test(a) === !0) i = a;
          else if (Df.test(a) === !0)
            i = `ionicons ion-${
            ...
            const c = a.match(Lo);
            c !== null && ((a = a.substring(6)), (i += cl[c[1]])), (l = a);
          } else {
            i = "notranslate material-icons";
            const c = a.match(Ff);
            c !== null && ((a = a.substring(2)), (i += al[c[1]])), (l = a);
          }
      ...
      return () => {
        ...
        return o.value.none === !0
          ? z(e.tag, i, If(t.default))
          : o.value.img === !0
          ? z(e.tag, i, Qt(t.default, [z("img", { src: o.value.src })]))
          : o.value.svg === !0
          ? z(
              e.tag,
              i,
  ...
  Vf = _n({
    ...
    setup(e, { slots: t }) {
      const n = gs(e),
        ...
        s = V(() => (e.fontSize ? { fontSize: e.fontSize } : null));
      return () => {
        const o = e.icon !== void 0 ? [z(zn, { name: e.icon })] : void 0;
  ...
  Uf = { size: { type: [Number, String], default: "1em" }, color: String };
function Kf(e) {
  return {
...
const ul = _n({
  name: "QSpinner",
  props: { ...Uf, thickness: { type: Number, default: 5 } },
  setup(e) {
...
const Qf = Mf({
      ...
      const r = {
        ...
        start(s) {
          r.enabled === !0 &&
            ...
            Oo(s, e, r, s.qKeyEvent === !0);
        },
        keystart: Gf((s) => {
          r.enabled === !0 &&
            s.qSkipRipple !== !0 &&
            Fr(s, r.modifiers.keyCodes) === !0 &&
  ...
  Jf = Object.keys(fl),
  Yf = { align: { type: String, validator: (e) => Jf.includes(e) } };
function Xf(e) {
  return V(() => {
    const t =
...
function nd(e, t) {
  if (Object.keys(e).length !== Object.keys(t).length) return !1;
  for (const n in e) if (td(e[n], t[n]) === !1) return !1;
  return !0;
}
const rd = {
  to: [String, Object],
...
function sd({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const n = gn(),
    ...
    m = V(() =>
      a.value === !0
        ...
        : c.value === !0
        ? { href: f.value.href, target: r.target }
        : {}
    ),
    b = V(() => {
      ...
      if (Q !== -1) return Q;
      const Y = Mo(q[M - 2]);
      return M > 1 && Mo(ee) === Y && j[j.length - 1].path !== Y
        ? j.findIndex(Io.bind(null, q[M - 2]))
        : Q;
    }),
    T = V(
      () =>
        c.value === !0 && b.value !== -1 && ed(s.$route.params, f.value.params)
    ),
    C = V(
      () =>
        T.value === !0 &&
        b.value === s.$route.matched.length - 1 &&
        nd(s.$route.params, f.value.params)
    ),
    R = V(() =>
      c.value === !0
        ? C.value === !0
  ...
  function B(
    q,
    { returnRouterError: M, to: ee = r.to, replace: j = r.replace } = {}
  ) {
    if (r.disable === !0) return q.preventDefault(), Promise.resolve(!1);
    if (
      q.metaKey ||
      q.altKey ||
      q.ctrlKey ||
    ...
    return M === !0 ? Q : Q.then(() => {}).catch(() => {});
  }
  function D(q) {
    if (c.value === !0) {
      const M = (ee) => B(q, ee);
      o("click", q, M), q.defaultPrevented !== !0 && M();
    } else o("click", q);
  }
  return {
    hasRouterLink: c,
...
const Bo = { none: 0, xs: 4, sm: 8, md: 16, lg: 24, xl: 32 },
...
function fd(e) {
  const t = gs(e, od),
    ...
    m = V(() => {
      ...
      return (
        s.value === !0
          ? Object.assign(C, i.value)
          : id.includes(e.type) === !0 && (C.type = e.type),
        o.value === "a"
          ? (e.disable === !0
              ? (C["aria-disabled"] = "true")
              : C.href === void 0 && (C.role = "button"),
            r.value !== !0 && ld.test(e.type) === !0 && (C.type = e.type))
          : e.disable === !0 &&
  ...
  setup(e, { slots: t, emit: n }) {
    ...
    const R = V(() => e.label !== void 0 && e.label !== null && e.label !== ""),
      ...
      q = V(() => {
        ...
        if (p.value === !0) {
          const $ = { onClick: ee, onKeydown: j, onMousedown: Y };
      ...
      if (d.value !== null) {
        if ($ !== void 0) {
          ...
          if (
            e.type === "submit" &&
            ne !== document.body &&
            d.value.contains(ne) === !1 &&
            ne.contains(d.value) === !1
          ) {
            d.value.focus();
            const ae = () => {
    ...
    function O($) {
      const ne = m.value;
      $ !== !0 &&
        (Tt === d.value || Lt === d.value) &&
        ne !== null &&
        ne !== document.activeElement &&
        (ne.setAttribute("tabindex", -1), ne.focus()),
        Tt === d.value &&
          (b !== null &&
            (b.removeEventListener("touchcancel", te, Te),
            b.removeEventListener("touchend", te, Te)),
          (Tt = b = null)),
        Lt === d.value &&
          (document.removeEventListener("mouseup", te, Te), (Lt = null)),
        At === d.value &&
          (document.removeEventListener("keyup", te, !0),
    ...
    return (
      ...
      () => {
        ...
        e.icon !== void 0 &&
          ...
          R.value === !0 && $.push(z("span", { class: "block" }, [e.label])),
          ($ = Qt(t.default, $)),
          e.iconRight !== void 0 &&
            e.round === !1 &&
            $.push(
                ...
                e.loading === !0
                  ? [
                      z(
                        ...
                        t.loading !== void 0 ? t.loading() : [z(ul)]
                      ),
                    ]
                  : null
              )
...
function pl(e, t, n) {
  if (!e) return Wt("parameter required");
  let r;
  const s = { textColor: "white" };
  if (
    (e.ignoreDefaults !== !0 && Object.assign(s, $n),
    dn(e) === !1 &&
      (s.type && Object.assign(s, $t[s.type]), (e = { message: e })),
    Object.assign(s, $t[e.type || s.type], e),
    typeof s.icon == "function" && (s.icon = s.icon(t)),
    s.spinner
      ? (s.spinner === !0 && (s.spinner = ul), (s.spinner = zt(s.spinner)))
      : (s.spinner = !1),
    (s.meta = {
    ...
    if (ms.includes(s.position) === !1) return Wt("wrong position", e);
  } else s.position = "bottom";
  if (_d.includes(s.timeout) === !0) s.timeout = 5e3;
  else {
    const l = Number(s.timeout);
    if (isNaN(l) || l < 0) return Wt("wrong timeout", e);
  ...
  const o = (Array.isArray(e.actions) === !0 ? e.actions : [])
      .concat(
        e.ignoreDefaults !== !0 && Array.isArray($n.actions) === !0
          ? $n.actions
          : []
      )
      .concat(
        $t[e.type] !== void 0 && Array.isArray($t[e.type].actions) === !0
          ? $t[e.type].actions
          : []
      ),
    { closeBtn: i } = s;
  if (
    ...
    if (l === void 0) {
      if (
        ...
        Ie[s.position].value.splice(
          Math.floor(Ie[s.position].value.length / 2),
          0,
          s
        );
      else {
  ...
  if (
    ...
    return (l) => {
      l !== void 0
        ? Wt("trying to update a grouped one which is forbidden", e)
        : a();
    };

...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  // img.style.width = '100%';
  img.src = "./2048-cupcakes/style/img/" + tile.value + ".jpg";
...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  tweet.setAttribute("data-via", "doodlecricket");
  tweet.setAttribute("data-url", "https://www.developedgame.com/");
  tweet.setAttribute("data-counturl", "https://www.developedgame.com/");
  tweet.textContent = "Tweet";

  var text =
    Localize("tweet1") +
    Localize(this.score).toUpperCase() +
    '", ' +
    this.points +
    " Kcal " +
    Localize("tweet2");

define(['exports'], function (t) {
  ...
  const n = {
    ...
    i = (t) => [n.prefix, t, n.suffix].filter((t) => t && t.length > 0).join('-'),
    r = (t) => {
      ;((t) => {
        for (const e of Object.keys(n)) t(e)
      })((e) => {
  ...
  const a = (t) => (t && 'object' == typeof t ? t : { handle: t })
  class h {
  ...
  let f
  const w = () => (f || ((f = new l()), f.addFetchListener(), f.addCacheListener()), f)
  function d(t, e, n) {
    let i
    if ('string' == typeof t) {
      const s = new URL(t, location.href)
      i = new h(({ url: t }) => t.href === s.href, e, n)
    } else if (t instanceof RegExp) i = new u(t, e, n)
    else if ('function' == typeof t) i = new h(t, e, n)
    else {
      if (!(t instanceof h))
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                o = await t.keys(e, r)
              for (const e of o) if (i === q(e.url, s)) return t.match(e, n)
    ...
    async getCacheKey(t, e) {
      ...
      if (!this.u[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = L(await t({ mode: e, request: n, event: this.event, params: this.params }))
        this.u[s] = n
      }
      return this.u[s]
    }
  ...
  class O extends E {
    constructor(t = {}) {
      ;(t.cacheName = o(t.cacheName)),
        super(t),
        (this.C = !1 !== t.fallbackToNetwork),
        this.plugins.push(O.copyRedirectedCacheableResponsesPlugin)
    }
    async _(t, e) {
    ...
    async N(t, e) {
      ...
      if (!this.C) throw new s('missing-precache-entry', { cacheName: this.cacheName, url: t.url })
      {
        ...
        ;(n = await e.fetch(new Request(t, { integrity: 'no-cors' !== t.mode ? r || s : void 0 }))),
          s && o && 'no-cors' !== t.mode && (this.j(), await e.cachePut(t, n.clone()))
      }
      return n
    }
    async O(t, e) {
    ...
    j() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== O.copyRedirectedCacheableResponsesPlugin &&
          (n === O.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++)
      0 === e
        ? this.plugins.push(O.defaultPrecacheCacheabilityPlugin)
  ...
  class x {
    constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
      ;(this.k = new Map()),
        ...
        (this.l = new O({
          cacheName: o(t),
          plugins: [...e, new R({ precacheController: this })],
          fallbackToNetwork: s,
        })),
  ...
  ;(t.NavigationRoute = class extends h {
    constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
      super((t) => this.W(t), t), (this.M = e), (this.S = s)
    }
    W({ url: t, request: e }) {
    ...
    (t.createHandlerBoundToURL = function (t) {
      return j().createHandlerBoundToURL(t)
    }),

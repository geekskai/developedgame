...
var Da = function (a, b, c, d) {
  ...
  Ea = function (a, b, c) {
    p(a) ||
      Da('Expected number but got %s: %s.', [da(a), a], b, Array.prototype.slice.call(arguments, 2))
    return a
  }
var Fa = function (a) {
  Fa[' '](a)
...
var Ia = Array.prototype.indexOf
  ...
  Ka = Array.prototype.map
    ...
    : function (a, b, c) {
        for (var d = a.length, e = Array(d), f = n(a) ? a.split('') : a, h = 0; h < d; h++)
...
var ob = kb,
  ...
  pb
var qb = k.document
pb = qb && z ? ib() || ('CSS1Compat' == qb.compatMode ? parseInt(ob, 10) : 5) : void 0
...
var Db = function (a, b) {
  var c = b.type
  c in a.F && Oa(a.F[c], b) && (Ab(b), 0 == a.F[c].length && (delete a.F[c], a.ub--))
}
...
var Eb = 'closure_lm_' + ((1e6 * Math.random()) | 0),
  ...
  Pb = function (a, b, c, d, e) {
    if (ea(b)) for (var f = 0; f < b.length; f++) Pb(a, b[f], c, d, e)
      ...
      (c = Ib(c)), xb(a) ? a.Ja(b, c, d, e) : a && (a = Kb(a)) && (b = a.ib(b, c, !!d, e)) && Qb(b)
  },
  Qb = function (a) {
    if (!p(a) && a && !a.Sa) {
      var b = a.src
      if (xb(b)) Db(b.U, a)
        ...
        Gb--
        ;(c = Kb(b)) ? (Db(c, a), 0 == c.ub && ((c.src = null), (b[Eb] = null))) : Ab(a)
      }
    }
  },
  Mb = function (a) {
...
var Vb = hb && Ub && !C(536.25),
  ...
  Xb = function (a) {
    ...
    b && b.canPlayType && (b.canPlayType('audio/mpeg') || b.canPlayType('audio/ogg'))
      ? ((b.controls = !1),
        (b.hidden = !0),
        (b.loaded = !1),
...
F.prototype.Ja = function (a, b, c, d, e) {
  if (ea(b)) for (var f = 0; f < b.length; f++) this.Ja(a, b[f], c, d, e)
    ...
    (c = c || this.handleEvent),
      ...
      (c = Ib(c)),
      (d = !!d),
      (b = xb(a) ? a.ib(b, c, d, e) : a ? ((a = Kb(a)) ? a.ib(b, c, d, e) : null) : null),
...
g.dispatchEvent = function (a) {
  ...
  a.Fa ||
    ((f = a.currentTarget = c), (e = cc(f, d, !0, a) && e), a.Fa || (e = cc(f, d, !1, a) && e))
  if (b)
    for (h = 0; !a.Fa && h < b.length; h++) (f = a.currentTarget = b[h]), (e = cc(f, d, !1, a) && e)
  return e
}
g.l = function () {
  G.g.l.call(this)
...
g.translate = function (a, b) {
  a instanceof I
    ...
    : (Ea(a), (this.left += a), (this.right += a), p(b) && ((this.top += b), (this.bottom += b)))
  return this
}
g.scale = function (a, b) {
  var c = p(b) ? b : a
...
g.w = function (a, b, c) {
  ...
  f = d.createElement(f)
  h && (n(h) ? (f.className = h) : ea(h) ? (f.className = h.join(' ')) : zc(f, h))
  2 < e.length && Cc(d, f, e)
  return f
}
...
var Hc = function (a, b, c) {
  ...
  Kc = function (a, b) {
    return Jc(a, b) || (a.currentStyle ? a.currentStyle[b] : null) || (a.style && a.style[b])
  },
  Mc = function (a, b, c) {
    var d
...
var M = function (a, b, c) {
    ...
    b.I && a.I && b.getParent() == a
      ? ((a = a.h), (d = a.childNodes[d] || null), d != b.b() && a.insertBefore(b.b(), d))
      : c
        ? (a.h || a.w(), (d = a.H ? a.H[d + 1] || null : null), Vc(b, a.h, d ? d.h : null))
        : a.I && !b.I && b.h && b.h.parentNode && 1 == b.h.parentNode.nodeType && b.A()
  },
  Xc = function (a, b) {
    a.H && x(a.H, b, void 0)
  }
...
t(N, G)
var Zc = k.document && k.document.documentElement && !!k.document.documentElement.setCapture,
  $c = {
    ie: 'earlycancel',
    zd: 'start',
    ee: 'beforedrag',
...
N.prototype.Fd = function (a) {
  if (this.sa) {
    ...
    if (!this.ra) {
      ...
      if (d * d + e * e > this.Uc)
        if (this.dispatchEvent(new bd('start', this, a.clientX, a.clientY))) this.ra = !0
        else {
          this.Ma || this.Ba(a)
          return
        }
    ...
    c = c.y
    this.ra &&
      this.dispatchEvent(new bd('beforedrag', this, a.clientX, a.clientY, 0, b, c)) &&
  ...
  if (this.Ic) {
    ...
    if (c) {
      if (A)
        var d = Qc(c),
          b = b + d.left
      else 8 <= Number(pb) && !(9 <= Number(pb)) && ((d = Qc(c)), (b -= d.left))
...
N.prototype.Qc = function (a, b) {
  this.Ic && ad(this) ? (this.target.style.right = a + 'px') : (this.target.style.left = a + 'px')
...
t(bd, D)
var gd = 'StopIteration' in k ? k.StopIteration : { message: 'StopIteration', stack: '' },
  hd = function () {}
...
g.remove = function (a) {
  return kd(this.W, a)
    ? (delete this.W[a], this.o--, this.vb++, this.i.length > 2 * this.o && jd(this), !0)
    : !1
}
var jd = function (a) {
  if (a.o != a.i.length) {
...
nd.prototype.toString = function () {
  ...
  if ((c = this.Ub))
    this.eb && '/' != c.charAt(0) && a.push('/'), a.push(td(c, '/' == c.charAt(0) ? vd : wd, !0))
...
var rd = function (a, b) {
  ...
  td = function (a, b, c) {
    return n(a)
      ? ((a = encodeURI(a).replace(b, zd)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, '%$1')), a)
      : null
  },
  zd = function (a) {
    a = a.charCodeAt(0)
...
g.remove = function (a) {
  ...
  a = Bd(this, a)
  return this.m.bb(a)
    ? ((this.J = null), (this.o = Ea(this.o) - this.m.get(a).length), this.m.remove(a))
    : !1
}
g.clear = function () {
  this.m = this.J = null
  ...
  a &&
    ...
    this.m.forEach(function (a, c) {
      ...
      c != b &&
        ...
        this.remove(b),
        0 < a.length &&
          ((this.J = null), this.m.set(Bd(this, b), Qa(a)), (this.o = Ea(this.o) + a.length)))
    }, this))
  this.P = a
}
var Dd = function (a) {
...
var Jd = function (a) {
  ...
  Kd = function (a, b) {
    var c
    a.classList ? (c = a.classList.contains(b)) : ((c = Jd(a)), (c = 0 <= Ia(c, b)))
    return c
  },
  Ld = function (a, b) {
    a.classList
...
g.ia = function (a, b, c, d, e, f, h, l) {
  ...
  b.translate(c, d)
  b.scale(h ? -e : e, l ? -e : e)
  this.drawImage(b, a, 0, 0, P, jb, -P * (f ? 0.5 : h ? 1 : 0), -jb * (f ? 0.5 : l ? 1 : 0), P, jb)
  b.restore()
}
var he = function (a, b) {
  var c
  ...
  var d = a.Da(b),
    e = a.gb(b),
    f = b[5] || 1
  f && 1 != f && a.oc[ge(b)] && ((d = Math.floor(d / f)), (e = Math.floor(e / f)))
...
Le.prototype.A = function () {
  ...
  this.qa = new T(this, new J(0, 0, window.innerWidth - R, window.innerHeight - S))
  this.qa.sa = !1
  Ae(this, 'click', 'd')
...
var Me = function (a, b) {
  a.C && (a.j().Ja(a.C, 'a', a.Rb), a.j().Ja(a.C, 'b', a.ad), a.j().Ja(a.C, 'c', a.bd))
  a.C = b
  a.j().a(b, 'a', a.Rb)
  a.j().a(b, 'b', a.ad)
  a.j().a(b, 'c', a.bd)
...
g.moveTo = function (a, b, c) {
  if (this.ya != a || this.za != b || this.xd != c || this.kc) {
    ...
    this.xd = c
    Mc(d, a, b)
    Hc(d, 'zIndex', c + 1e3 * Math.floor((parseInt(d.style.zIndex, 10) || 0) / 1e3))
    this.qa.sa = !1
...
var Se = function (a) {
  if (a.empty()) {
    ...
    (b = a.G.Pb), a.size() < b && (b = a.size()), (b = a.pop(b)), a.N.push(b), a.dispatchEvent('v')
}
    ...
    Ma(
      ...
      function (c) {
        ...
        if ((d = c.hasListener('h'))) {
          ...
          var e = Ue(c.b())
          d =
            Math.min(d.left + d.width, e.left + e.width) >= Math.max(d.left, e.left) &&
            Math.min(d.top + d.height, e.top + e.height) >= Math.max(d.top, e.top)
        }
...
V.prototype.accept = function (a) {
  ...
  b.pop()
  this.push(a)
  b instanceof W ? this.dispatchEvent('y') : b instanceof Qe && this.dispatchEvent('B')
}
  ...
  if (this.enabled) {
    ...
    0 < a && a < 0.8 * this.Lb
      ...
      : (this.M && (this.Ua.clearTimeout(this.M), (this.M = null)),
        ...
        this.enabled && ((this.M = this.Ua.setTimeout(this.fc, this.Lb)), (this.qc = r())))
  }
}
g.start = function () {
  this.enabled = !0
...
var hf = ff.la(),
  jf = function (a) {
    L.call(this, a)
    this.ac = this.Zb = this.$b = this.Ha = this.ab = this.Hb = this.Jb = this.Db = this.na = null
  }
t(jf, L)
...
Y.prototype.Rb = function () {
  ...
  if (0 != a.length) {
    ...
    x(
      a,
      function (a, f) {
        a.Xa.moveTo(this.ya + c + f * this.qd, this.za + d + f * this.rd, f + 1)
        a.fb &&
...
g.nc = function () {
  ...
  this.uc.parentElement.children[0].innerHTML = Q('Number of moves played in the game')
...
var sf = function (a, b) {
    ...
    for (var d = 0; d < b; ++d) {
      ...
      e.style.transition = 'all ' + (2e3 + pc(1200)) + 'ms cubic-bezier(0.4, 0, 1, 1) 500ms'
...
var wf = function (a) {
  ...
  Af = function (a, b) {
    ...
    x(
      a.V,
      function (a, b) {
        var d = new Y(a, new J(c.Da() - c.qb - R, 16 * (0.5 * b + 1) + b * S, R, S))
        lf(d, 0.2)
        this.Ca.push(d)
      },
      a
...
Z.prototype.dd = function (a) {
  0 >= a || (this.pc == Be() ? setTimeout(q(this.dd, this, a - 1), 500) : this.Sb())
}
              ...
              je.la().Wb(0, function () {
                ...
                if (c.allMsgs) {
                  ...
                  for (var h = 0; h < c.allMsgs.messages.length; ++h)
                    c.msgs[c.allMsgs.messages[h]] = c.allMsgs.translations[d].ALL[h]
                }
                Wc(Kf, a)
                Jf.kb()
                Jf.log(1)

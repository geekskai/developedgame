...
;(function () {
  ...
  var ia = da,
    ...
    na = function (a, b) {
      if (b) {
        ...
        d = c[a]
        b = b(d)
        b != d && null != b && ma(c, a, { configurable: !0, writable: !0, value: b })
      }
    }
  na('Promise', function (a) {
    ...
    e.prototype.Ta = function (h) {
      if (h === this) this.w(new TypeError('A Promise cannot resolve to itself'))
    ...
    e.race = function (h) {
      return new e(function (g, k) {
        for (var l = ba(h), q = l.next(); !q.done; q = l.next()) c(q.value).yb(g, k)
      })
    }
    e.all = function (h) {
      var g = ba(h),
      ...
      return k.done
        ...
        : new e(function (l, q) {
            ...
            var U = [],
              pa = 0
            do U.push(void 0), pa++, c(k.value).yb(L(U.length - 1), q), (k = g.next())
            while (!k.done)
          })
    }
    return e
  ...
  var nb = cb,
    ob = (function () {
      ...
      try {
        wa.addEventListener('test', xa, b), wa.removeEventListener('test', xa, b)
      } catch (c) {}
      return a
    })()
  var pb = function () {
  ...
  var zb = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    ...
    Eb = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Eb(a, b[f], c, d, e)
      else if (((c = Fb(c)), a && a[tb])) a.g.add(String(b), c, !0, za(d) ? !!d.capture : !!d, e)
      else {
        if (!b) throw Error('f')
        f = za(d) ? !!d.capture : !!d
        var h = Gb(a)
        ...
        if (!c.g) {
          ...
          if (a.addEventListener)
            ob || (d = f), void 0 === d && (d = !1), a.addEventListener(b.toString(), e, d)
      ...
      if ((a = Gb(a)))
        if ((b = a.g[b.toString()]))
          for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a]
            f && f.capture == c && !f.ub && ((f = Ib(f, d)), (e = e && !1 !== f))
          }
      return e
    },
    Ib = function (a, b) {
      ...
      if (a.Eb && 'number' !== typeof a && a && !a.ub) {
        ...
        if (e && e[tb]) yb(e.g, a)
          ...
          Bb--
          ;(f = Gb(e)) ? (yb(f, a), 0 == f.i && ((f.src = null), (e[zb] = null))) : wb(a)
        }
      }
      return c.call(d, b)
    },
    Cb = function (a, b) {
      ...
      if (!bb) {
        ...
        if (!(0 > d.keyCode || void 0 != d.returnValue)) {
          ...
          for (e = 0; e < d.length; e++) (b.g = d[e]), (f = Jb(d[e], a, !1, b)), (c = c && f)
        }
        return c
      }
  ...
  var Lb = function (a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof Lb) for (c = a.tb(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]))
  ...
  var Mb = function (a) {
    ...
    if (a.j != a.g.length) {
      var e = {}
      for (c = b = 0; b < a.g.length; ) (d = a.g[b]), Nb(e, d) || ((a.g[c++] = d), (e[d] = 1)), b++
      a.g.length = c
    }
  }
  ...
  var Ub = !(!window.AudioContext && !window.webkitAudioContext) && !!window.GainNode,
    p = function (a, b, c) {
      this.Kb = a
      this.W = b
      this.U = c
  ...
  p.prototype.play = function (a, b, c, d, e, f) {
    ...
    this.v
      ? (this.j ? this.j.connect(this.v) : d.connect(this.v), this.v.connect(this.w))
      : this.j
    ...
    b
      ? ((d.loopStart = a + (e ? c / 1e3 : 0)), (d.loopEnd = a + h), d.start(f, a + c / 1e3))
      : d.start(f, a + c / 1e3, h)
    e = this.Ka++
  ...
  var Xb = document.createElement('audio'),
    Yb = 'function' == ya(Xb.canPlayType) && '' != Xb.canPlayType('audio/mpeg') ? '.mp3' : '.ogg',
    Zb = function (a, b) {
      Ba.call(this, a + b + Yb)
      this.j = this.w = null
      this.g = 0
  ...
  ec.prototype.toString = function () {
    ...
    if ((c = this.g))
      this.j && '/' != c.charAt(0) && a.push('/'), a.push(kc(c, '/' == c.charAt(0) ? mc : nc, !0))
  ...
  var fc = function (a, b, c) {
    ...
    hc = function (a, b, c) {
      b instanceof r ? ((a.i = b), pc(a.i, a.U)) : (c || (b = kc(b, qc)), (a.i = new r(b, a.U)))
    },
    jc = function (a, b) {
  ...
  r.prototype.v = function (a) {
    sc(this)
    var b = []
    if ('string' === typeof a) vc(this, a) && (b = Fa(b, this.g.get(tc(this, a))))
    else {
      a = this.g.v()
      ...
      b &&
        ...
        a.g.forEach(function (c, d) {
          ...
          d != e &&
            (uc(this, d),
            uc(this, e),
            0 < c.length && ((this.j = null), this.g.set(tc(this, e), Ga(c)), (this.i += c.length)))
        }, a))
      a.w = b
    }
  var t = navigator.userAgent,
    ...
    isMobile =
      yc || m(t, 'Android') || m(t, 'Mobile') || m(t, 'Silk') || m(t, 'UCBrowser') || m(t, 'UCWEB')
  var Bc = Date.now,
    Cc = ['', 'moz', 'ms', 'o', 'webkit'],
    Dc = function (a) {
      var b = document
  ...
  Ic.prototype.Ta = function () {
    ...
    this.g &&
      (this.i && document.removeEventListener
        ...
        : window.agsa_ext && window.agsa_ext.registerPageVisibilityListener && (this.g = null))
    pb.prototype.Ta.call(this)
  }
  var Fc = function (a) {
      if (!a.mb && !a.Ra && window.agsa_ext && window.agsa_ext.getPageVisibility)
    ...
    Lc = function (a) {
      var b = a.v || a.w
      a.U && !b ? ((a.U = !1), a.lc(), Hc(a)) : !a.U && b && ((a.U = !0), a.Cb())
    },
    Hc = function (a) {
  ...
  var Rc = [],
    ...
    Xc = function (a, b, c) {
      return 'undefined' == typeof a.axes[b] ? !1 : c ? -0.75 > a.axes[b] : 0.75 < a.axes[b]
    },
    Zc = function (a) {
      Pc.Ab = a.gamepad
      Wc || ((Wc = !0), Yc())
          ...
          : window.oRequestAnimationFrame
            ...
            : window.mozRequestAnimationFrame
              ...
              : window.msRequestAnimationFrame
                ...
                : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(Yc))
    }
  var v = function () {
    ...
    Te = function (a) {
      if (a.dir && a.Ta[hd]) {
        ...
        if (b[0] != a.S[0] || b[1] != a.S[1]) {
          ...
          a.H || C[b[0]][b[1]].path
            ? (a.W = [b[0], b[1]])
            : ((a.o[0] = a.W[0]), (a.o[1] = a.W[1]), (b[0] = a.W[0]), (b[1] = a.W[1]), (a.dir = 0))
          ...
          if (!a.H && C[b[0]][b[1]].Pa) {
            ...
            if (70 == rd || 170 == rd) (Xd = !0), (Ed = H[15] + (H[16] - H[15]) * Ie())
            0 == D && Y(9)
            X()
          }
          a.S[0] = b[0]
          ...
          (c = [8 * Math.floor(c), 8 * Math.floor(d)]),
            a.o[1] == c[1] &&
              ...
              a.H ||
                ...
                ((c = a.id), Xd && (Se('fruit'), (Xd = !1), (Yd = !0), (Ed = H[14]), Re(A.Ga, c))),
              a.H && Ke(a, !1),
              (c = C[a.o[0]][a.o[1]]),
              c.Va &&
                (a.g && a.g & c.La
                  ? (0 != a.dir && (a.U = a.dir),
                    (a.dir = a.g),
                    (a.g = 0),
                    a.H || ((a.o[0] += a.Qa[0]), (a.o[1] += a.Qa[1]), (a.Qa = [0, 0])))
                  : 0 == (a.dir & c.La) &&
                    (0 != a.dir && (a.U = a.dir), (a.dir = 0), (a.g = 0), Oe(a, 0))))
  ...
  Ce.prototype.move = function () {
    if (0 == F || (this.H && 1 == F && (8 == this.mode || 64 == this.mode))) {
            ...
            if (0 == this.dir) C[this.o[0]][this.o[1]].La & a && (this.dir = a)
              ...
              if (b && b.La & a) {
                ...
                c[0] == this.S[0] && c[1] == this.S[1]
                  ? (d = 1)
                  : ((c[b.axis] -= b.Na), c[0] == this.S[0] && c[1] == this.S[1] && (d = 2))
                if (d) {
                  this.dir = a
                  this.o[0] = this.S[0]
                  this.o[1] = this.S[1]
      ...
      this.w ? (Ne(this), 64 == this.mode && Ne(this)) : (Te(this), 8 == this.mode && Te(this))
    }
  }
  var Ve = function (a) {
    ...
    Me = function (a) {
      ...
      if (8 == F || 14 == F) var b = [0, 3]
        ...
        if (10 == F || 4 == F || 3 == F) {
          ...
          c = 11
        } else if (4 != a.mode && ((16 != a.mode && 32 != a.mode) || 4 != fd || a.nb))
          if (8 == a.mode || 64 == a.mode) {
            ...
            c = 10
          } else if ('pcm-ghin' == a.s) (c = 8), (b = 6 + (Math.floor(I / 16) % 2))
          else if ('pcm-gbug' == a.s) (b = 6), (c = 9 + (Math.floor(I / 16) % 2))
          else if ('pcm-ghfa' == a.s) (b = 3 == K ? 6 : 7), (c = 11)
          else if ('pcm-stck' == a.s)
            (b = 1 == K ? (60 < nd ? 1 : 45 < nd ? 2 : 3) : 2 == K ? 3 : 3 == K || 4 == K ? 4 : 0),
              (c = 13)
          else {
            c = a.g
        ...
        if (1 == F && a.id == jd) (b = 3), (c = 0)
          ...
          if (4 == F || 5 == F || 7 == F) (b = 0 == a.id ? 2 : 4), (c = 0)
            ...
            (b = 14), (c = Math.floor(0.2 * I) % 4), 3 == c && (c = 1), (c *= 2)
    ...
    We = function () {
      E = []
      for (var a = 0; a < z + 4; a++)
        (E[a] = new Ce(a)), a < z ? ((E[a].H = !1), (E[a].mode = 1)) : (E[a].H = !0)
    },
    Ye = function (a) {
      Mc(sd)
      a || (a = window.event)
    ...
    Ze = function (a, b) {
      ...
      var e = c.o[0] + c.Qa[0] + 0 + 32,
        f = Math.abs(a - d),
        h = Math.abs(b - e)
      8 < f && h < f ? (c.Oa = a > d ? 8 : 4) : 8 < h && f < h && (c.Oa = b > e ? 2 : 1)
    },
    $e = function (a) {
      Mc(sd)
      a || (a = window.event)
    ...
    af = function (a) {
      Mc(sd)
      1 < a.touches.length ? df() : ((td = a.touches[0].pageX - vd), (ud = a.touches[0].pageY - wd))
      a.preventDefault()
    },
    bf = function (a) {
      Mc(sd)
    ...
    ff = function (a) {
      ...
      A.kc || ((A.$ = Math.round(90 * A.$)), (A.Fb = A.$ + H[1] * (2 * A.Fa - 1)), (A.kc = !0))
      for (var b = 0; b < E.length; b++) E[b].lb = 0
      ed = Sd = !1
      for (b = qd = pd = rd = D = 0; b < re.length; b++) {
        var c = re[b]
        c.T ? ((c = c.x + c.T - 1), c > pd && (pd = c)) : ((c = c.y + c.h - 1), c > qd && (qd = c))
      }
      C = []
      for (b = 0; b <= qd + 1; b++)
        for (C[8 * b] = [], c = -2; c <= pd + 1; c++) C[8 * b][8 * c] = { path: 0, Pa: 0, Va: 0 }
    ...
    Le = function (a) {
      if (!Zd[a]) {
        ...
        Zd[a] = []
        for (var d = 0; 90 > d; d++)
          (b += a), Math.floor(b) > c ? (Zd[a].push(!0), (c = Math.floor(b))) : Zd[a].push(!1)
      }
      return Zd[a]
    },
    Y = function (a) {
    ...
    Ue = function () {
      P &&
        (P.style.backgroundPosition = google.doodle.pacManSound ? '-216px -105px' : '-236px -105px')
    },
    ef = function () {
      yd = !1
      O = !0
    ...
    of = function () {
      13 != F && (0 == I % (2 * H[17]) ? (Od = !0) : I % (2 * H[17]) == H[17] && (Od = !1))
    },
    pf = !1,
    qf = !1,
    rf = function () {
      ...
      if (13 == F) {
        ...
        for (a = 0; a < b; a++) {
          ...
          if (0 == F && dd) {
            ...
            for (c = z; c < z + 4; c++)
              if (
                ((d = E[c]), d.id == z && D < A.Aa && 2 == d.mode && (!ed || 16 != E[z + 3].mode))
              )
          ...
          switch (F) {
            ...
            case 14:
              ...
              break
            default:
              0 == I % (2 * H[0]) ? (Nd = !0) : I % (2 * H[0]) == H[0] && (Nd = !1)
          }
          of()
          if (0 == F) {
            if (Wd && (Wd--, 0 >= Wd)) {
            ...
            if (0 >= G)
              switch (((G = 0), F)) {
                case 1:
                  ...
                  d = !1
                  for (c = z; c < z + 4; c++)
                    if (4 == E[c].mode || ((16 == E[c].mode || 128 == E[c].mode) && !E[c].nb)) {
                      d = !0
                      break
                    }
                  d || Qe(gd, !1)
      ...
      if (O) {
        if (Jd) {
          ...
          if (Nd)
            for (d = 8; d <= 8 * qd; d += 8)
              for (e = 8; e <= 8 * pd; e += 8)
                2 == C[d][e].Pa && ((a = e + -32 + 10), (c = d + 0 + 40), W(2, 182, 8, 8, a, c))
        ...
        if (Id) {
          ...
          for (a = 280; 472 >= a; a += 8)
            for (c = 0; 136 >= c; c += 8)
              0.03 > Ie() && ((Qd = 10 * Math.floor(25 * Ie())), (Rd = 10 * Math.floor(2 * Ie()))),
    ...
    tf = function (a) {
      ...
      for (var c = 0; c < de; c++) {
        var d = b.substr(c, 1)
        d && W(((8 + 8 * parseInt(d, 10)) / 8) * 10 + 2, 182, 8, 8, a + 8 * c, 24)
      }
    },
    sf = function () {
      for (var a = Math.max(N - 4 + 1, 1), b = N; b >= a; b--) {
        var c = lf(b >= ye.length ? ye[ye.length - 1].ka : ye[b].ka)
        W((c[0] / 8) * 10 + 2, (c[1] / 8) * 10 + 2, 32, 16, 466 - 16 * (1 + b - a), 184)
      }
    },
    Re = function (a, b) {
      Ad[b] += a
      !Bd[b] && 1e4 < Ad[b] && (Se('extra-life'), (Bd[b] = !0), Cd++, 5 < Cd && (Cd = 5))
    },
    Se = function (a) {
    ...
    Z = function () {
      if (ge) {
        for (var a = ba(R.keys()), b = a.next(); !b.done; b = a.next()) R.get(b.value).stop()
        he = null
      }
    },
    Pe = function (a) {
      ...
      if (me && ne && (zf(1), !le)) {
        ...
        window.addEventListener
          ? (window.addEventListener('keydown', Ye, !1),
            ...
            document.f && document.f.q && document.f.q.addEventListener('touchstart', cf, !0))
          : (document.body.attachEvent('onkeydown', Ye), M.attachEvent('onclick', $e))
        H = {}
        for (var b in xe)
          H[b] = Math.round(90 * (google.doodle.pacManSound || (7 != b && 8 != b) ? xe[b] : 1))
  ...
  if (
    ...
    oe = R.size
    for (var Gf = ba(R.values()), Hf = Gf.next(); !Hf.done; Hf = Gf.next()) Hf.value.Kb.preload(Cf)
  } else (me = !0), Af()
  Sc[0] = 37
  Sc[1] = 39
  Sc[2] = 38
  ...
  ;(!navigator.webkitGamepads && !navigator.webkitGetGamepads) || Wc || ((Wc = !0), Yc())
}).call(this)

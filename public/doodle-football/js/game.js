...
;(function () {
  ...
  var sa = -1 != l.indexOf('Opera') || -1 != l.indexOf('OPR'),
    ...
    wa = (function () {
      var a = '',
        b
      if (sa && aa.opera) return (a = aa.opera.version), 'function' == ba(a) ? a() : a
      ta
        ? (b = /rv\:([^\);]+)(\)|;)/)
        : m
          ? (b = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/)
    ...
    ya = aa.document,
    za = ya && m ? va() || ('CSS1Compat' == ya.compatMode ? parseInt(wa, 10) : 5) : void 0
  var Ca = function (a) {
      var b = new Image(),
        c = Aa,
        d = ''
  ...
  var Da,
    ...
    Ja = function () {
      var a = (window.localStorage && window.localStorage.getItem('doodle-soccer-tooltip')) || null
  ...
  Wa.prototype.clone = function () {
    var a = new Wa(this.T, this.w, this.aa, this.ba, this.p, this.s, this.R, this.S)
    a.J = this.J
    a.A = this.A
    a.frame = this.frame
    a.F = this.F
  ...
  Wa.prototype.v = function () {
    if ((!this.w.complete && 'complete' != this.w.readyState) || !this.i) return !1
    ...
    if (0 >= d + a + c || 0 >= e + b + c || d - c > this.T.width || e - c > this.T.height) return !1
    this.B.save()
    ...
    var f = (0 > this.k ? -a : a) / 2,
      ...
      e = this.x + f - d * f + c * g,
      f = this.y + g - d * g - c * f
    this.F && ((e += this.F * (Math.random() - 0.5)), (f += this.F * (Math.random() - 0.5)))
    0 > this.k && (e += a)
    0 > this.o && (f += b)
    var g = this.U / b,
      h = this.V / a
    ...
    try {
      if (this.H || this.D)
        for (
          ...
          for (b = 0; b < q; b++)
            Ya(this, b * this.p, a * this.s, b == q - 1 ? fa : this.p, a == D - 1 ? ab : this.s)
  ...
  var $a = function (a, b, c) {
      var d
      void 0 == d && (d = a.i)
      d == c ? (a.i = c) : (a.C && Qa(a.C), (a.C = new r()), u(a.C, Za(a, d, c), b), a.C.play())
    },
    w = function (a) {
    ...
    Ya = function (a, b, c, d, e) {
      ...
      0 > d ||
        0 > e ||
        a.B.drawImage(a.w, f + a.frame * a.p, g, d, e, a.W + a.R + b, a.X + a.S + c, d, e)
    }
  var bb = {},
          ...
          : window.oRequestAnimationFrame
            ...
            : window.mozRequestAnimationFrame
              ...
              : window.msRequestAnimationFrame
                ...
                : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(ib))
    },
    lb = function (a) {
      fb = gameElement
      gb = a || null
      ...
      ;(!navigator.webkitGamepads && !navigator.webkitGetGamepads) || hb || ((hb = !0), ib())
    }
  var mb = function (a, b) {
      google &&
        google.doodle &&
  ...
  var Kb = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    ...
    Tb = function (a, b, c, d, e) {
      if ('array' == ba(b)) for (var f = 0; f < b.length; f++) Tb(a, b[f], c, d, e)
      else
        (c = Ob(c)),
          a && a[Ab]
            ? a.unlisten(b, c, d, e)
    ...
    Ub = function (a) {
      ...
      Mb--
      ;(c = Pb(b)) ? (Ib(c, a), 0 == c.k && ((c.src = null), (b[Kb] = null))) : Db(a)
      return !0
    },
    Rb = function (a) {
  ...
  var Zb = function (a, b) {
    ...
    var g = !0,
      h
    if (c)
      for (var k = c.length - 1; !e.o && 0 <= k; k--) (h = e.k = c[k]), (g = Yb(h, f, !0, e) && g)
    e.o || ((h = e.k = d), (g = Yb(h, f, !0, e) && g), e.o || (g = Yb(h, f, !1, e) && g))
    if (c) for (k = 0; !e.o && k < c.length; k++) (h = e.k = c[k]), (g = Yb(h, f, !1, e) && g)
    return g
  }
  ...
  E.prototype.unlisten = function (a, b, c, d) {
    ...
    if (a in e.i) {
      ...
      b = Gb(f, b, c, d)
      ;-1 < b
        ? (Db(f[b]), ma.splice.call(f, b, 1), 0 == f.length && (delete e.i[a], e.k--), (e = !0))
        : (e = !1)
    } else e = !1
    return e
  }
  ...
  var hc,
    ...
    Tc = function () {
      ...
      ic.appendChild(hc)
      for (var e = 0; 3 > e; e++) (Gc[e] = p('div', 'hplogo_sm')), ic.appendChild(Gc[e])
      I.appendChild(ic)
      e = function (a) {
        a = p('div', a)
        I.appendChild(a)
  ...
  var Z = [],
    V = function (a, b, c, d, e, f, g) {
      ...
      d || (d = Ad.i[a][2])
      e || (e = Ad.i[a][3])
      return new Wa(canvas, zd, h + (b || 0), k + (c || 0), d, e, f || 0, g || 0)
    },
    de = function (a) {
      Q.x = a
      Q.y = 93
    ...
    Vc = function (a, b) {
      ...
      1 == ud && ld && md && fe(2)
      yd += b
      4 == gameStatus && 2e3 < yd && 3 > id && ((yd = 0), Id ? ((U = Jd), Sa.play()) : Kd())
      N[2] && 150 <= playerX
        ? (playerX -= 5)
        : (N[2] && 150 <= playerX ? 0 : N[3] && 390 >= playerX) && (playerX += 5)
      be()
      for (var d = playerX, e = 0, f; (f = jd[e++]); ) {
        ...
        g.height += g.i * h
        var k = 0.2
        2 == g.state && (k = 0.015 * Math.sqrt(Math.abs(g.p - g.y) + Math.abs(g.o - g.x)))
        var t = h * k,
        ...
        g.y += t
        0 > g.height
          ? ((g.height = 0), (g.i = 0.1 > Math.abs(g.i) ? 0 : (g.i = 0.6 * -g.i)))
        ...
        1 == f.state &&
          ...
          50 < Math.abs(f.x - d) || (f.A && !Xd) || (!f.A && Xd)
            ? ((f.state = 3), id++)
            : ((f.state = 2), M++, (f.o = 200 + 200 * Math.random()), (f.p = 50), (f.i = 0)))
      }
    ...
    ie = function () {
      for (var a = v(sd), b = 0; b < id; b++) (sd.x = b * a + 6 * b + 39), (sd.y = 10), sd.v()
    ...
    Zd = function () {
      ...
      lc.F = Bc + c
      b || (b = kc)
      lc.C = 'https://www.google.com/logos/2012/' + b + '12-hp-share' + a + '.png'
      hc.textContent = c
      for (b = 0; 3 > b; b++) Gc[b].className = b < a ? 'hplogo_smg' : 'hplogo_smh'
      I.style.display = ''
      J.play()
    },
    ...
    ke = function (a) {
      return 37 == a.keyCode ? 2 : 39 == a.keyCode ? 3 : 38 == a.keyCode || Ga(a.keyCode) ? 1 : 0
    },
    le = function (a) {
      2 != Fc && (Fc = 0)
      var b = ke(a)
    ...
    Wc = function () {
      ...
      ;-1 != navigator.userAgent.indexOf('Opera') && (gameElement.onkeypress = bd)
      updateGameStatus(1)
      K()
    },
    playerJump = function () {
